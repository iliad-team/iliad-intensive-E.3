...
Examples:
  ...
  %(prog)s --chapters=1.3.* --ruff_format=true
    ...
    # Validate chapter pattern starts with a chapter id (digit or cluster letter)
    if not args.chapters[0].isalnum():  # ILIAD day codes are letter.number, e.g. E.3
    ...
    for file_id in files_to_process:
        ...
        chapter_num = file_id.split(".")[0]  # "E" for E.3; config keys are strings
